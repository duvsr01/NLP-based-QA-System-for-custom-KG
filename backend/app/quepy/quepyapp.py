...
from backend.app.quepy import generation
from backend.app.quepy.parsing import QuestionTemplate
from backend.app.quepy.tagger import get_tagger, TaggingError
from backend.app.quepy.encodingpolicy import encoding_flexible_conversion
...
def install(app_name):
    ...
    for module_name, module_path in module_paths.items():
        try:
            ...
            message = u"Error importing {0!r}"
            raise ImportError(message.format(module_path.format(app_name)))
